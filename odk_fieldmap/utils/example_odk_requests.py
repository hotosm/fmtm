...
projectId = odk_requests.project_id(base_url, aut, projectName = 'Reetta_example_odk_requests') #get project id for the created project
...
odk_requests.create_app_user(base_url, aut, projectId) # Creates an app user called surveyor
...
qr_data_dict = odk_requests.generate_qr_data_dict(base_url, aut, projectId) # The first values is app user id and second the qr string
