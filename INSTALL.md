...
[9]: #easy-install "Easy Install"
[10]: #manual-install "Manual Install"
[11]: #table-of-contents "Table of Contents"
[12]: #clone-the-fmtm-repository "Clone the FMTM repository"
[13]: #setup-your-local-environment "Setup Your Local Environment"
[14]: #1-setup-osm-oauth-20 "1. Setup OSM OAUTH 2.0"
[15]: #2-create-an-env-file "2. Create an `.env` File"
[16]: #start-the-api-with-docker "Start the API with Docker"
[17]: #select-the-install-type "Select the install type"
[18]: #pull-the-images "Pull the Images"
[19]: #build-the-frontend "Build the Frontend"
[20]: #start-the-containers "Start the Containers"
[21]: #setup-odk-central-user-optional "Setup ODK Central User (Optional)"
[22]: #import-test-data-optional "Import Test Data (Optional)"
[23]: #check-authentication-optional "Check Authentication (Optional)"
[24]: #alternative-operating-systems "Alternative Operating Systems"
[25]: #windows "Windows"
[26]: #macos "MacOS"
[27]: #a-note-on-docker-desktop "A Note on Docker Desktop"
