...
:+1::tada: **First off, we here at the Humanitarian OpenStreetMap Team (HOT) are delighted that you are reading this. We need volunteer developers (contributors) like you, to help improve the Field Mapping Tasking Manager (FMTM)!** :tada::+1:

We welcome and encourage contributors of all skill levels and we are committed to making sure your participation is inclusive, enjoyable and rewarding. If you have never contributed to an open source project before, this is the perfect place to start. We will make sure you are supported every step of the way. If you have **any** questions, feel free to ask through; comments, issues or the best alternative that works for you!
