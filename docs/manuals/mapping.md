...
- We recommend using the Chrome browser on your mobile device to access
  the FieldTM platform for optimal performance.
- If you encounter difficulties using FieldTM through the browser, you can
  add the FieldTM browser shortcut to your home screen via the menu.
...
!!! tip
      ...
      PMTiles are used for navigating in FieldTM.
...
- Once the geometry is drawn on FieldTM, save and confirm to be redirected to ODK.
...
- Once the form is submitted, you have to get back to FieldTM and select the
