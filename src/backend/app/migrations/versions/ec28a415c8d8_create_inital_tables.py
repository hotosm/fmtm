...
def upgrade() -> None:
    ...
    op.drop_index('clusteredbuildings_idx', table_name='clusteredbuildings', postgresql_using='gist')
    ...
    op.drop_index('taskpolygons_idx', table_name='taskpolygons', postgresql_using='gist')
    ...
    op.drop_table('place')
    op.drop_index('lowfeaturecountpolygons_idx', table_name='lowfeaturecountpolygons', postgresql_using='gist')
    ...
    op.drop_index('splitpolygons_idx', table_name='splitpolygons', postgresql_using='gist')
    ...
    op.drop_index('dumpedpoints_idx', table_name='dumpedpoints', postgresql_using='gist')
...
def downgrade() -> None:
    ...
    op.create_index('dumpedpoints_idx', 'dumpedpoints', ['geom'], unique=False, postgresql_using='gist')
    ...
    op.create_index('buildings_idx', 'buildings', ['geom'], unique=False, postgresql_using='gist')
    ...
    op.create_index('splitpolygons_idx', 'splitpolygons', ['geom'], unique=False, postgresql_using='gist')
    ...
    op.create_table('lowfeaturecountpolygons',
    sa.Column('polyid', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('geom', geoalchemy2.types.Geometry(geometry_type='POLYGON', srid=4326, from_text='ST_GeomFromEWKT', name='geometry', _spatial_index_reflected=True), autoincrement=False, nullable=True),
    sa.Column('geog', geoalchemy2.types.Geography(from_text='ST_GeogFromText', name='geography'), autoincrement=False, nullable=True),
    sa.Column('numfeatures', sa.BIGINT(), autoincrement=False, nullable=True),
    ...
    sa.Column('sharedbound', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('polyid', name='lowfeaturecountpolygons_pkey')
    )
    op.create_index('lowfeaturecountpolygons_idx', 'lowfeaturecountpolygons', ['geom'], unique=False, postgresql_using='gist')
    ...
    op.create_index('taskpolygons_idx', 'taskpolygons', ['geom'], unique=False, postgresql_using='gist')
    ...
    op.create_table('voronois',
    sa.Column('clusteruid', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('geom', geoalchemy2.types.Geometry(from_text='ST_GeomFromEWKT', name='geometry', _spatial_index_reflected=True), autoincrement=False, nullable=True)
    )
    op.create_index('voronois_idx', 'voronois', ['geom'], unique=False, postgresql_using='gist')
    ...
    op.create_table('clusteredbuildings',
    sa.Column('id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('project_id', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('osm_id', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('geom', geoalchemy2.types.Geometry(geometry_type='POLYGON', srid=4326, from_text='ST_GeomFromEWKT', name='geometry', _spatial_index_reflected=True), autoincrement=False, nullable=True),
    ...
    op.create_index('clusteredbuildings_idx', 'clusteredbuildings', ['geom'], unique=False, postgresql_using='gist')
