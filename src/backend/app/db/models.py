...
class DbOdkEntities(BaseModel):
    ...
    async def upsert(
        ...
        """
        log.info(
            f"Updating FieldTM database Entities for project {project_id} "
    ...
    async def update(
        ...
        """Update the entity value in the FieldTM db."""
...
class DbBasemap(BaseModel):
    ...
    TODO for now we generate the basemap entry in FieldTM.
