  ...
  const totalTaskInfoCount = [
    {
      ...
      title: "Total Tasks",
      icon: (
        <AssetModules.TaskIcon sx={{ color: "#d73f3e", fontSize: "50px" }} />
      ),
    },
    {
      ...
      icon: (
        <AssetModules.SubmissionIcon
          sx={{ color: "#d73f3e", fontSize: "50px" }}
        />
      ),
    },
    {
      ...
      icon: (
        <AssetModules.FeatureIcon sx={{ color: "#d73f3e", fontSize: "50px" }} />
      ),
    },
  ];
  return (
