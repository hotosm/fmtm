  ...
  return (
    <CoreModules.Stack>
      ...
      >
        <CoreModules.Stack>
          {iconCloseMode && (
            <CoreModules.Stack style={{ float: 'right' }} mt={'2%'} mr={'1%'} borderRadius={60} height={50} width={40}>
        ...
        <CoreModules.DialogContent>{element}</CoreModules.DialogContent>
        <CoreModules.DialogActions>{iconCloseMode != true && actionsButton}</CoreModules.DialogActions>
      </CoreModules.Dialog>
    </CoreModules.Stack>
  );
}
