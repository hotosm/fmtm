...
export default function ExploreProjectCardXs() {
    const [shadow, setShadow] = React.useState('0')
    const onFocusIn = () => {
        setShadow('2px 2px 1px 1px #ffd9cc')
    }
    const onFocusOut = () => {
        setShadow('0 0 1px 1px #ffffff')
    ...
    return (
        <Card style={cardInnerStyles.card} sx={{ maxWidth: 370 }} onMouseEnter={onFocusIn} onMouseLeave={onFocusOut}>
