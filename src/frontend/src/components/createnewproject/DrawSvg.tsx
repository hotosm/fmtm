...
const DrawSvg = () => {
  return (
    <svg viewBox="0 0 60 60" className="h1 w1 v-mid" style={{ marginRight: '0.5rem', width: '20px' }}>
          ...
          <g transform="translate(736,250)">
            ...
            <g transform="translate(30,24)">
              ...
              <path
                ...
                style={{ mixBlendMode: 'multiply' }}
              ></path>
              <polygon points="5.625,5.625 9.375,5.625 9.375,9.375 5.625,9.375 " fill="#ffffff"></polygon>
              <polygon points="50.625,13.125 54.375,13.125 54.375,16.875 50.625,16.875 " fill="#ffffff"></polygon>
              <polygon points="46.875,41.25 50.625,41.25 50.625,45 46.875,45 " fill="#ffffff"></polygon>
              <polygon points="11.25,50.625 15,50.625 15,54.375 11.25,54.375 " fill="#ffffff"></polygon>
            </g>
          </g>
        </g>
      </g>
