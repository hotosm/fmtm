...
const ManageProject = () => {
  ...
  return (
    <div className="fmtm-flex fmtm-flex-col sm:fmtm-flex-row fmtm-bg-[#F5F5F5] fmtm-p-5 fmtm-gap-8 lg:fmtm-min-h-full">
      <div className="sm:fmtm-w-[15%] sm:fmtm-min-w-[7.3rem] fmtm-flex sm:fmtm-flex-col fmtm-items-center fmtm-gap-4 sm:fmtm-gap-0">
        ...
        <div className="fmtm-flex fmtm-flex-row sm:fmtm-flex-col">
          {tabList.map((tab) => (
            <div
              key={tab.id}
