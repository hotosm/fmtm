...
const organizationDataList = organizationTypeList.map(
...
const OrganizationAddForm = () => {
    ...
    const submission = () => {
        ...
        // submitForm();
        dispatch(OrganizationService(`${environment.baseApiUrl}/projects/organization/`, values));
    ...
    return (
        <form onSubmit={handleSubmit} style={{ height: '100%' }}>
            <CoreModules.FormGroup sx={{ height: '100%', overflow: 'scroll', flexWrap: 'nowrap' }}>
                <CoreModules.Typography variant="subtitle2" sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>Add Organization</CoreModules.Typography>
                {/* Organization Name Form Input For Create Project */}
                <CoreModules.FormControl sx={{ mb: 0, width: '100%', }}>
                    <CoreModules.Box sx={{ display: 'flex', flexDirection: 'row', pt: 0 }}><CoreModules.FormLabel component="h3">Name</CoreModules.FormLabel><CoreModules.FormLabel component="h3" sx={{ color: 'red' }}>*</CoreModules.FormLabel></CoreModules.Box>
                ...
                <CoreModules.FormControl sx={{ mb: 0, width: '100%', }}>
                    <CoreModules.Box sx={{ display: 'flex', flexDirection: 'row', pt: 0 }}><CoreModules.FormLabel component="h3">Website</CoreModules.FormLabel><CoreModules.FormLabel component="h3" sx={{ color: 'red' }}>*</CoreModules.FormLabel></CoreModules.Box>
                    <CoreModules.TextField
                        id="url"
                        label=""
                        variant="filled"
                ...
                <CoreModules.FormControl sx={{ mb: 0, width: '50%', }}>
                    <CoreModules.Box sx={{ display: 'flex', flexDirection: 'row', pt: 0 }}><CoreModules.FormLabel component="h3">Logo</CoreModules.FormLabel><CoreModules.FormLabel component="h3" sx={{ color: 'red' }}>*</CoreModules.FormLabel></CoreModules.Box>
                    <CoreModules.TextField
                        id="logo"
                        label=""
                        variant="filled"
                ...
                <CoreModules.FormControl sx={{ mb: 0, width: '100%', }} variant="filled">
                    ...
                    {errors.type && <CoreModules.FormLabel component="h3" sx={{ color: defaultTheme.palette.error.main }}>{errors.type}</CoreModules.FormLabel>}
                </CoreModules.FormControl>
