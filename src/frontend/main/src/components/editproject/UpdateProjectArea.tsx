...
const UpdateProjectArea = ({ projectId }) => {
    ...
    const outline_geojson = useSelector<any>((state) => state.createproject.editProjectDetails.outline_geojson);
    const dividedTaskGeojson = useSelector<any>((state) => state.createproject.dividedTaskGeojson);
    const dividedTaskGeojsonLoading = useSelector<any>((state) => state.createproject.dividedTaskLoading);
    const updateBoundaryLoading = useSelector<any>((state) => state.createproject.updateBoundaryLoading);
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        dispatch(
            EditProjectBoundaryService(`${enviroment.baseApiUrl}/projects/edit_project_boundary/${projectId}/`,
                uploadAOI, projectBoundaryDetails?.dimension),
        );
    }
    return (
