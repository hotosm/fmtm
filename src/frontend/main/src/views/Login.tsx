    ...
    return (
        <CoreModules.Stack direction={'row'} justifyContent={'center'}>
            <CoreModules.Stack width={600}  p={2} spacing={2}>
                ...
                />
                <CoreModules.Button onClick={handleOnSubmit} style={btnStyles} color="error" variant="contained">sign in</CoreModules.Button>
                <CoreModules.Typography>
                    don't have an account ? <CoreModules.Link style={{textDecoration:'none'}} to={'/signup'}>Sign up</CoreModules.Link> 
                </CoreModules.Typography>
            </CoreModules.Stack>
        </CoreModules.Stack>
    )
