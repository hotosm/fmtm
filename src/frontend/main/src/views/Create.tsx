    ...
    return (
        <CoreModules.Stack direction={'row'} justifyContent={'center'}>
            <CoreModules.Stack width={600}  p={2} spacing={2}>
                ...
                />
                <CoreModules.Button onClick={handleOnSubmit} style={btnStyles} disabled={token != null} color="error" variant="contained">sign up</CoreModules.Button>
                <CoreModules.Typography>
                    Already have an account ? <CoreModules.Link style={{textDecoration:'none'}} to={'/login'}>Sign in</CoreModules.Link> 
                </CoreModules.Typography>
            </CoreModules.Stack>
        </CoreModules.Stack>
    )
