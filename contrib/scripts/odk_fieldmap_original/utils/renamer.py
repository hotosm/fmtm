...
"""Accepts
- A directory with forms or QR codes for an FieldTM project.

Renames all of the files with the schema needed by the FieldTM uploader.
"""
import os
import sys
...
if __name__ == "__main__":
    """
    Renames a directory full of files to match FieldTM format
    """
